        ...
        <div className="flex overflow-x-auto">
          ...
          >
            <span className="flex items-center justify-center gap-2">
              ...
              <span className="hidden sm:inline">{t.features.booking.title}</span>
            </span>
          </button>
          <button
          ...
          >
            <span className="flex items-center justify-center gap-2">
              ...
              <span className="hidden sm:inline">{t.features.reminders.title}</span>
            </span>
          </button>
          <button
          ...
          >
            <span className="flex items-center justify-center gap-2">
              ...
              <span className="hidden sm:inline">{t.features.autoReply.title}</span>
            </span>
          </button>
        </div>
      </div>
      ...
      <div className="p-6">
          ...
          <div className="grid lg:grid-cols-2 gap-8">
            ...
            <div>
              ...
              >
                ...
                {t.features.booking.whatsappBook}
              </a>
            </div>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700 p-6">
              <h4 className="font-semibold text-gray-900 dark:text-white mb-4 text-center">
                {t.features.booking.formTitle}
              </h4>
              <div className="space-y-4">
                <div>
                  <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
                    {t.features.booking.selectService}
                  </label>
                  <select
                ...
                <button
                  ...
                  disabled
                >
                  {t.features.booking.submit}
                </button>
                <p className="text-xs text-center text-gray-500 dark:text-gray-400">
                  {t.features.booking.confirmation}
                </p>
              </div>
            </div>
          </div>
                ...
                <div className="space-y-6">
                  ...
                  <div className="relative flex gap-4">
                    ...
                    <div className="flex-1 bg-white dark:bg-gray-800 rounded-xl p-4 shadow-sm border border-gray-200 dark:border-gray-700">
                      ...
                      <p className="text-gray-600 dark:text-gray-300 text-sm">{t.features.reminders.step1}</p>
                  ...
                  <div className="relative flex gap-4">
                    ...
                    <div className="flex-1 bg-white dark:bg-gray-800 rounded-xl p-4 shadow-sm border border-gray-200 dark:border-gray-700">
                      ...
                      <p className="text-gray-600 dark:text-gray-300 text-sm">{t.features.reminders.step2}</p>
                      <div className="mt-3 bg-green-50 dark:bg-green-900/20 rounded-lg p-3 border-l-4 border-green-500">
                        <p className="text-sm text-gray-700 dark:text-gray-300">
                          {isRTL 
                  ...
                  <div className="relative flex gap-4">
                    ...
                    <div className="flex-1 bg-white dark:bg-gray-800 rounded-xl p-4 shadow-sm border border-gray-200 dark:border-gray-700">
                      ...
                      <p className="text-gray-600 dark:text-gray-300 text-sm">{t.features.reminders.step3}</p>
                      <div className="mt-3 bg-green-50 dark:bg-green-900/20 rounded-lg p-3 border-l-4 border-green-500">
                        <p className="text-sm text-gray-700 dark:text-gray-300">
                          {isRTL 
        ...
        {activeTab === 'autoReply' && (
          <div>
            <div className="max-w-2xl mx-auto">
              <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-3 text-center">
                {t.features.autoReply.title}
              </h3>
              <p className="text-gray-600 dark:text-gray-300 mb-8 text-center">
                {t.features.autoReply.description}
              </p>

              {/* Auto-Reply Examples */}
              <div className="space-y-4">
                <h4 className="font-medium text-gray-700 dark:text-gray-300 mb-4">
                  {t.features.autoReply.example}
                </h4>
                ...
                <div className="bg-gray-100 dark:bg-gray-700 rounded-2xl p-4 space-y-3">
                  ...
                  <div className="flex justify-start">
                    <div className="bg-white dark:bg-gray-600 rounded-2xl rounded-bl-sm px-4 py-2 max-w-[80%] shadow-sm">
                      <p className="text-sm text-gray-800 dark:text-gray-200">{t.features.autoReply.greeting}</p>
                  ...
                  <div className="flex justify-start">
                    <div className="bg-white dark:bg-gray-600 rounded-2xl rounded-bl-sm px-4 py-2 max-w-[80%] shadow-sm">
                      <p className="text-sm text-gray-800 dark:text-gray-200">{t.features.autoReply.hours}</p>
                      <p className="text-xs text-gray-400 mt-1">{isRTL ? 'رد تلقائي' : 'Auto-reply'}</p>
                    </div>
                  </div>
                  ...
                  <div className="flex justify-start">
                    <div className="bg-white dark:bg-gray-600 rounded-2xl rounded-bl-sm px-4 py-2 max-w-[80%] shadow-sm">
                      <p className="text-sm text-gray-800 dark:text-gray-200">{t.features.autoReply.location}</p>
                      <p className="text-xs text-gray-400 mt-1">{isRTL ? 'رد تلقائي' : 'Auto-reply'}</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-amber-50 dark:bg-amber-900/20 rounded-xl p-4 border border-amber-200 dark:border-amber-800">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-amber-700 dark:text-amber-300">{t.features.autoReply.afterHours}</p>
                    </div>
                  </div>
                </div>
